...
In the Form Builder, use the **Insert New Section** menu (＋) on any section and choose **Divider** under _Formatting_.

## Step 2: Pick a Style

Open the divider section's **Divider Style** panel and choose a style from the **Style** dropdown. _Simple Line_ is the default.

![Choosing a divider style in the Form Builder](../.gitbook/assets/147-divider-style-picker-demo.gif)
