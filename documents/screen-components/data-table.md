...
![Data Table displaying records with inline editing](../.gitbook/assets/data-table-records.png)
...
![Inline editing in the data table](../.gitbook/assets/data-table-inline-edit.gif)
