...
![Calendar date/time picker with selectable slots](../.gitbook/assets/calendar-datetime-picker.png)

![Calendar integrated with repeater component](../.gitbook/assets/calendar-with-repeater.png)
