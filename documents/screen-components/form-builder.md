...
![Preview form in Flow Builder](../.gitbook/assets/preview-form-in-flow-builder.png)
...
* **Form\_\_mdt** — The top-level form component definition (object, name, theme, settings)
* **Form\_Section\_\_mdt** — Sections within a form component (order, label, visibility)
* **Form\_Field\_\_mdt** — Individual fields within a section (field API name, label overrides, validation, order)
* **Form\_Conditional\_Logic\_\_mdt** — Visibility rules for sections and fields
...
* **Naming Convention**: Use descriptive names for your form components (e.g., "Account\_Quick\_Edit" or "Contact\_Full\_Intake") — these names appear in the Flow Form property editor.
