...
![Repeater displaying contact cards with edit and delete actions](../.gitbook/assets/repeater-overview-cards.png)
...
![Advanced edit modal with form fields](../.gitbook/assets/repeater-edit-modal-open.png)

### Drag-and-Drop Reordering

Users can arrange records by dragging them into the desired order.

![Drag and drop reordering in action](../.gitbook/assets/repeater-drag-arrange.gif)
...
| `bottomMargin`                | String  | slds-m-bottom\_none | Bottom margin SLDS class              |
...
* **Accordion Display**: For complex records, enable `enableAccordion` so each record collapses into a compact header, which reduces visual clutter with many records.
