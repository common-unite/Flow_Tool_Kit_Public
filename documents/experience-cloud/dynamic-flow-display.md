...
| ------------- | ------ | -------- | --------- | --------------------------------------------------------------------------- |
| `flowApiName` | String | Yes      | None      | API Name of the Screen Flow to display                                      |
| `buttonLabel` | String | No       | None      | Label for the button (used with `button` and `modal` display types)         |
| `recordId`    | String | No       | None      | Record Id to pass to the flow (optional on App/Home pages)                  |
...
| Property      | Type   | Required | Default   | Description                                    |
| ------------- | ------ | -------- | --------- | ---------------------------------------------- |
| `flowApiName` | String | Yes      | None      | API Name of the Screen Flow                    |
| `buttonLabel` | String | No       | None      | Button label text                              |
...
| Property     | Type   | Required | Default     | Description                                         |
| ------------ | ------ | -------- | ----------- | --------------------------------------------------- |
| `properties` | String | N/A      | None        | JSON configuration (managed by the property editor) |
