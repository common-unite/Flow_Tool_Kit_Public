...
![Prompt message displayed on field focus](../.gitbook/assets/prompt-message-display.png)
...
![Rich text editor for prompt messages](../.gitbook/assets/prompt-rich-text-editor.png)

## Rich Text Formatting

Prompt messages support full rich text formatting:

* **Bold**, _italic_, and other text styles
