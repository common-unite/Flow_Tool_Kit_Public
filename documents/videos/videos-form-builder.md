# Form Builder & Component Videos

> Video walkthroughs for Form Builder, Flow Form, Data Table, and general screen components.
...
|-------|----------|-------------|
| Welcome to Flow Tool Kit | 758693651 | Package overview and capabilities |
| Getting Started | 758693729 | Installation and first form setup |
| Form Builder Overview | 758694367 | The drag-and-drop form editor interface |
...
| Video | Vimeo ID | Description |
|-------|----------|-------------|
| Header Component | 758695800 | Configurable header with title, subtitle, and icon |
| Custom Buttons | 758695850 | Custom button bar with actions and conditional visibility |
| Lookup Component | 758695900 | Lookup/search field with filtering and multi-select |
| Illustrations Display | 758695950 | SLDS illustration component for empty states |
| Signature Pad | 758696000 | Signature capture field setup |

## Invocable Actions

| Video | Vimeo ID | Description |
|-------|----------|-------------|
| Invocable Actions Overview | 758696050 | What invocable actions are and how to use them |
| Upsert Bypass Duplicates | 758696100 | Insert/update while bypassing duplicate rules |
| Record Merge | 758696150 | Merging duplicate records in flows |
| Collection Utilities | 758696200 | Working with record collections |
| JSON Serialize/Deserialize | 758696250 | Converting between records and JSON |
| File Upload Actions | 758696300 | Handling file uploads in forms |
| DateTime Utilities | 758696350 | Date/time conversion and formatting |
