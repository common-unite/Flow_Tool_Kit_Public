...
![Confirmation page configuration on a form template](../.gitbook/assets/confirmation-page-config.png)

![Confirmation settings section](../.gitbook/assets/confirmation-settings.png)
