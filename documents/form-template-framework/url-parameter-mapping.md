...
> Capture values straight from the link: map URL query parameters into Form Submission fields the moment a Form Template loads, no Flow required.
...
![Quick Action on Form Template](../.gitbook/assets/url-param-mapping-quick-action.png)
...
![Mapping Editor](../.gitbook/assets/url-param-mapping-editor.png)
...
{% hint style="info" %}
The `pv1` to `pv9` parameters are the same general-purpose parameters used by [iframe embeds](../advanced-topics/iframe-embed.md), so an embedded form and a directly-linked form can share one mapping configuration.
{% endhint %}
...
- [Iframe Embed](../advanced-topics/iframe-embed.md): passing pv1 to pv9 into embedded forms
